...
export const surfaceRealtimeKeywordsSpec: ActionSpec<SurfaceRealtimeKeywordsInput> = {
  ...
  goal: "Memilih keyword chips near realtime dari kata atau topik penting yang disebut interviewer terbaru.",
  role: "Kamu adalah classifier keyword realtime untuk overlay interview.",
  task: [
    "Baca potongan transcript interviewer terbaru dan realtimeContext application.",
    "Pilih maksimal 3 keyword atau short phrase yang paling berguna untuk diklik kandidat saat interview berlangsung.",
    "Keyword harus berasal dari term/topik yang disebut atau tersirat langsung di transcript terbaru.",
    "Gunakan CV/JD/domain profile hanya sebagai filter atau ranking ringan ketika terlalu banyak kandidat, bukan sebagai sumber keyword baru.",
  ...
  policyRules: [
    ...
    "Pertahankan casing asli untuk acronym, tool, platform, dan istilah teknis yang disebut interviewer.",
    "Jangan hardcode atau memprioritaskan contoh dari dokumen, test, mockup, brand, platform, metric, domain, company, role, seed concept, atau CV/JD.",
    "Jangan mengeluarkan keyword dari CV, JD, seed concept, in-scope concept, atau domain profile jika term itu tidak muncul atau tidak tersirat langsung di transcript terbaru.",
