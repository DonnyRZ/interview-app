export const meetingConvoResponseFormatRules = [
  "For TANGGAPI and legacy BANTU_JAWAB in Convo mode, produce a natural response the user can say aloud, not an answer to an imaginary question.",
  ...
  "For TANGGAPI and legacy BANTU_JAWAB in Convo mode, every output line must start with '- ' and no other line format is allowed.",
  "For TANGGAPI and legacy BANTU_JAWAB in Convo mode, every bullet must be a declarative response sentence, not a question.",
  "For TANGGAPI and legacy BANTU_JAWAB in Convo mode, do not add an unbulleted intro paragraph or closing paragraph.",
  ...
  "Do not turn TANGGAPI or legacy BANTU_JAWAB Convo into a diagnostic checklist, formal article, pitch, lecture, or generic mini-plan."
];
