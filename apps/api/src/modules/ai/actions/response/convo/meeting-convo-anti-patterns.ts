export const meetingConvoAntiPatternRules = [
  ...
  "For TANGGAPI and legacy answer action in Convo mode, do not ask the other speaker or the user anything; clarification belongs to Pertanyaan Follow-up.",
  ...
  "Do not use question-led endings such as apakah, bagaimana kalau, bagaimana jika, siapa yang, or apa aspek unless the user selected Pertanyaan Follow-up.",
